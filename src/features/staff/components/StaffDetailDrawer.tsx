    ...
    >
      {loading || !staff ? (
        ...
        <div className="flex flex-col gap-6">
          ...
          {(isAdmin || user?.id === staff.userId) && staff.bankAccount && (
            <section>
              ...
              <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                <div className="grid grid-cols-[120px_1fr] gap-y-2 text-sm">
                  ...
                  <div className="font-medium text-slate-800">{staff.bankAccount.bankName}</div>
                  
                  <div className="text-slate-500">Account Name</div>
                  <div className="font-medium text-slate-800 uppercase">{staff.bankAccount.accountName}</div>
                  
                  <div className="text-slate-500">Account No.</div>
                  <div className="font-medium tracking-wide text-slate-800">{staff.bankAccount.accountNumber}</div>
                </div>
              </div>
            </section>
          )}
